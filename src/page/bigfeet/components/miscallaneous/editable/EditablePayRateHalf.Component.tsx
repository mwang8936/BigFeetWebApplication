...
interface EditablePayRateHalfProp {
...
const EditablePayRateHalf: FC<EditablePayRateHalfProp> = ({
	originalAmount,
	totalAmount,
	...
	const fillHalfClick = () => {
		setAmount(
			roundToTheNearestDollar ? Math.round(totalAmount / 2) : totalAmount / 2
		);
			...
			<div className="div-input">
				...
				<div className="ms-3">
					<PermissionsButton
						...
						disabled={!editable || amount === totalAmount / 2}
						missingPermissionMessage={
							!editable ? missingPermissionMessage : 'Already Halved.'
						}
						onClick={fillHalfClick}
					/>
				</div>
...
export default EditablePayRateHalf;
