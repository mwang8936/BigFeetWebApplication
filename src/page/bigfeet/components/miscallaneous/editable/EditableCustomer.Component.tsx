...
interface EditableCustomerProp {
	customers: Customer[];
...
const EditableCustomerInput: FC<EditableCustomerProp> = ({
	customers,
	originalCustomer,
	customer,
	setCustomer,
	...
	const [disabled, setDisabled] = useState(
		originalCustomer?.customer_id !== undefined
	);
	...
	useEffect(() => {
		setDisabled(originalCustomer?.customer_id !== undefined);
	...
	useEffect(() => {
		if (phoneNumber || vipSerial || customerName || notes) {
			setCustomer(null);
		} else {
			setCustomer(originalCustomer);
		}
	}, [phoneNumber, vipSerial, customerName, notes]);
