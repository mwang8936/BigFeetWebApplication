...
export default function EditableDropDown(prop: EditableDropDownProp) {
					...
					<>
						...
						<div className='flex relative rounded-md shadow-sm'>
							<Listbox.Button className='editable-input'>
								...
								<span className='pointer-events-none absolute inset-y-0 right-[50%] ml-3 flex items-center pr-2'>
									<ChevronUpDownIcon
