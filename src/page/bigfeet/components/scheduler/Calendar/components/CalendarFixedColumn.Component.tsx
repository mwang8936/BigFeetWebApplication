...
export default function CalendarFixedColumn(prop: CalendarFixedColumnProp) {
	...
	const getTimeDiv = (time: string, index: number) => {
		...
		return (
			<div
				...
				className={`col-start-[1] border-slate-300 border-r text-xs p-1.5 text-right text-black uppercase sticky left-0 z-[5] bg-white font-medium ${
	...
	return (
		<>
			<div className="row-start-[1] col-start-[1] sticky top-0 left-0 z-[5] bg-white border-slate-100 bg-clip-padding text-slate-900 border-b text-sm font-medium py-2" />
